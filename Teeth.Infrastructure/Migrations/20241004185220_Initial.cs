        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositValue = table.Column<float>(type: "real", nullable: false),
                    WithdrawValue = table.Column<float>(type: "real", nullable: false),
                    TotalValue = table.Column<float>(type: "real", nullable: false),
                    IsDepositPaid = table.Column<bool>(type: "boolean", nullable: false),
                    IsFeedbackGiven = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicContracts", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ClinicCredentials",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClinicCredentials", x => x.Id);
                });
